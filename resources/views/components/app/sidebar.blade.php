<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('create-surat-tugas') ? 'active' : '' }}" href="{{ route('create-surat-tugas') }}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-scroll {{ is_current_route('create-surat-tugas') ? 'text-primary' : '' }}" style="font-size: 17px; color: #FFFFFF;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Create Letter</span>
                </a>
            </li>
            <!-- <li class="nav-item">
