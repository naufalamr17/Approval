                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-5">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <img src="../assets/img/mlpLogo.png" alt="Application Logo" class="img-fluid w-20 h-20 mb-4" />
                                ...
                                <div class="card-body">
                                    <form role="form" class="text-start" method="POST" action="sign-in">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control" placeholder="Enter your email address" aria-label="Email" aria-describedby="email-addon">
                                        </div>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-xs mx-auto">
                                        &#169; 2024
                                        <a class="text-dark font-weight-bold">PT. Makmur Lestari Primatama</a>
                                    </p>
                                </div>
                            </div>
                        </div>
